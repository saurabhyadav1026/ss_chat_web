...
const Chat = (props: any) => {
  ...
  const { searchInput, setSearchInput, setAppOption,appOption }: any = useContext(ChatContext)
    ...
    <>
      <div id="left_nav_main_bar" className="container-fluid m-0  left_bar left_nav_menu_bar col-12  flex-grow-1" style={{position:"relative",height:"80%"}}>
        ...
        <div className='container-fluid p-3 '>
          <input className='form-control' name="ignore-history" style={{ height: "40px" }} typeof='search' onChange={updateSearchInput} value={searchInput} type="search" placeholder='search your friends...' id="search_input"></input>
