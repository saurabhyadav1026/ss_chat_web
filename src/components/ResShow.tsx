...
const ResShow = (props: any) => {
  ...
  return (
    <div className="receiv_msg msg_box_a    px-3 hh-100 mt-1   " style={{alignItems:"flex-start"}}>
      {/*     <!-- for ai  response displaying  --> */}
      <div className=' p-1 py-1 msg_box_b d-flex bg-primary border' >
        <span className=' p-2  msg_font_style'>
          <Markdown remarkPlugins={[remarkGfm]}>{props.res_}</Markdown>
        </span>

        <span className='p-1 message-time '>
